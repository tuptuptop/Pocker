      ...
      <body>
        <script
          ...
          (function(){
            ...
            d.innerHTML = '<img src="/pocker-logo.png" alt="Pocker" style="width:80px;height:80px;margin-bottom:20px;border-radius:16px;filter:drop-shadow(0 8px 32px color-mix(in srgb,'+accent+' 45%, transparent))" />'
