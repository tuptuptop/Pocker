...
pub fn draw(f: &mut Frame, app: &App) {
    ...
    // Tabs
    let titles = vec!["Chat", "Plugins", "Skills", "Settings"];
    ...
    let input = Paragraph::new(app.input.as_str())
        .block(Block::default().borders(Borders::ALL).title("Input (Enter to send, Tab to switch, q to quit)"));
